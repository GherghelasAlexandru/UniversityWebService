...
namespace StudentWebService.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        [HttpGet("{id}/Materii si Note Obtinute")]
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        {
                            return NotFound("Media generale not found");
                        }
                    }
                    else
                    {
        ...
        [HttpGet("Returneaza toti studentii")]
        ...
        [HttpGet("{id}/Returneaza un student")]
